...
$$User_{profile} = Name \times X_{1} + Bachelor\_{degree} \times X_{2} + Master\_{degree} \times X_{3} + Job\_{experience} \times X_{4} + GitHub\_{repositories} \times X_{5} + URLs \times X_{6}$$
